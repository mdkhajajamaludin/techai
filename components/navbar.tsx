      ...
      <div className="flex flex-1 items-center">
        <Link href="/" className="flex items-center gap-2" target="_blank">
          <div className="flex items-center gap-2">
            <div className="relative flex items-center justify-center bg-white rounded-full p-0.5">
              <Image
                src="https://i.postimg.cc/RZwsBVjC/Chat-GPT-Image-Jun-19-2025-01-52-02-PM-removebg-preview.png"
                alt="Namtech Logo"
                width={40}
                height={36}
        ...
        {session ? (
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56" align="end">
              ...
              <DropdownMenuItem
                onClick={() => {
                  window.open('https://namtech.ai', '_blank')
                }}
              >
                About Namtech
              </DropdownMenuItem>
